...
public class snakeGame extends PApplet {
    ...
    public void drawFood(int maxWidth, int maxHeight){
        fill(0xffED1818);
        if(foodKey){
            foodX = PApplet.parseInt( random(0, maxWidth)/w ) * w;
            foodY = PApplet.parseInt( random(0, maxHeight)/w) * w;
        }
    ...
    static public void main(String[] passedArgs) {
        String[] appletArgs = new String[] { "works.snakeGame" };
        if (passedArgs != null) {
